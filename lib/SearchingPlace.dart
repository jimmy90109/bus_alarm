...
class _SearchingPlaceState extends State<SearchingPlace> {
  ...
  void getSuggestion(String input) async {
    ...
    if (searchMode == 2) {
      ...
      if (busToken.isNotEmpty) {
        var uri = Uri.parse('https://tdx.transportdata.tw/api/basic/v2/Bus/Route/City/Taipei/$input?%24top=20&%24format=JSON');
  ...
  void getBusToken() async {
    final response = await http.post(
      ...
      body: {'grant_type': 'client_credentials', 'client_id': 's110916034-d403baf7-99ce-40d0', 'client_secret': 'b5cc7437-c27f-4476-9401-ac87fc4cdf07'},
    );
                                      ...
                                      child: InkWell(
                                        ...
                                        child: ListTile(
                                          ...
                                          onTap: () async {
                                            ...
                                            // print(placeId);
                                            var response = await http.get(Uri.parse('https://maps.googleapis.com/maps/api/place/details/json'
                                                '?place_id=$placeId'
                                                '&language=zh-TW'
